...
const Icon = forwardRef<HTMLSpanElement, IconProps>(
  (
    ...
    const commerceStateClasses = {
      ...
      agreement: 'text-warning-600',
      execution: 'text-primary-600',
      settlement: 'text-gray-500',
      completion: 'text-gray-400',
      none: 'ring-0'
    };
    ...
    const getIconSVG = (iconName: string) => {
      const icons: Record<string, JSX.Element> = {
        ...
        'user-plus': (
          <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 6v6m-3-3h6" />
          </svg>
        ),
        // Action icons
        edit: (
        ...
        'skip-forward': (
          <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 4v16l6-8-6-8zm8 0v16l6-8-6-8z" />
          </svg>
        ),
        ban: (
          <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    const renderIcon = () => {
      ...
      // If name provided, try to get SVG icon
      if (name && name !== '') {
