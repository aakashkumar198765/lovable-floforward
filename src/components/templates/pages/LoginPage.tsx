 ...
 * Login Page Template
 *
 * This is a template example showing how to build a login page with email + OTP authentication.
 * AI can use this as a reference to understand the structure and replicate similar pages.
 *
 * Key Patterns:
 ...
 * - Enterprise features (RBAC, audit, encryption)
...
// Template demonstrates using reusable components
...
const LoginPageTemplate: React.FC = () => {
  ...
  // Template Timer Pattern for OTP resend
  useEffect(() => {
    if (resendTimer > 0) {
  ...
  // Template Email Submission Pattern
  const handleEmailSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    // Template Loading State Pattern
    setIsLoading(true);
    setError('');
    setSuccess('');

    try {
      // Template API Call Pattern
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      // Template Success Handling Pattern
      setCurrentStep('otp');
  ...
  // Template OTP Submission Pattern
  const handleOtpSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Template Success/Failure Pattern
  ...
  // Template Email Step Rendering Pattern
  const renderEmailStep = () => (
    <div className="space-y-8">
      ...
      <form onSubmit={handleEmailSubmit} className="space-y-6">
        ...
        {/* Template Submit Button Pattern */}
        <Button
          type="submit"
          variant="primary"
          size="md"
  ...
  // Template OTP Step Rendering Pattern
  const renderOtpStep = () => (
    <div className="space-y-6 mt-4">
      ...
      {/* Template OTP Form Pattern */}
      <form onSubmit={handleOtpSubmit} className="space-y-6">
        <div className="space-y-4">
          {/* Template OTP Input Pattern */}
        ...
        {/* Template Action Buttons Pattern */}
        <div className="space-y-4">
          <Button
            type="submit"
            variant="primary"
      ...
      {/* Template Security Notice Pattern */}
      <div className="text-center">
        <div className="flex items-center justify-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
  ...
  // Template Alert Rendering Pattern
  const renderAlerts = () => (
  ...
  // Template Loading Overlay Pattern
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center min-h-screen py-8 px-4 bg-gradient-to-br from-gray-50 via-white to-primary-50">
      {/* Template Branding Pattern - Vertical layout */}
